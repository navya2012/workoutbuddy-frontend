...
const Form = () => {
  ...
  const createSubmitData = async (e) => {
    ...
    const response = await axios.post('https://workoutbuddy-backend.vercel.app/api/workouts/newData', form,  {
      headers:{
  ...
  const updateSubmitData = async (e) => {
    ...
    await axios.patch(`https://workoutbuddy-backend.vercel.app/api/workouts/updateData/${_id}`, {
      title,
      reps,
      load
    },
